...
def main():
    ...
    for i in range(0,6):
        ...
        data = dtapokemex(pokemon_data_url)
    ...
    return render_template('pokedex.html', len = len(names), pokename = names, types = type, number = pokeid, photo = sprite)
def dtapokemex(url_pokemon=''):
    pokemon_data = {
        "name": '', 
        "types": '',
    }
